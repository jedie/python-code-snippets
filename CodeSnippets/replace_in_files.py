...
"""
    ...
    :copyleft: 2009-2019 by Jens Diemer
"""
...
class SearchAndReplace(object):
    def __init__(self, search_path, search_string, replace_string, search_only=True, file_filter=("*.*",)):
        ...
        print("Search '%s' in [%s]..." % (self.search_string, self.search_path))
        print("_" * 80)
        ...
        print("_" * 80)
        print("%s files searched in %0.2fsec." % (file_count, (time.time() - time_begin)))
    ...
    def replace_content(self, old_content, filepath):
        if self.is_re:
            ...
            new_content = old_content.replace(self.search_string, self.replace_string)
