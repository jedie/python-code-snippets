...
"""
    3dsmax input settings for blender

    Put this file to:
        ...\blender\2.62\scripts\presets\interaction\3dsmax.py

    Go to "File / User Preferences / Input / Presets" and select 3dsmax.

    Tested with blender v2.62
"""
...
print("Apply %r keyconfigs (...%s)" % (config_name, __file__[-48:]))

wm = bpy.context.window_manager

kc = wm.keyconfigs.new(config_name)
...
kmi = km.keymap_items.new('view3d.move', 'MIDDLEMOUSE', 'PRESS', alt=False)
...
bpy.context.user_preferences.inputs.invert_zoom_wheel = True

print("keyconfig %r activated!" % config_name)
